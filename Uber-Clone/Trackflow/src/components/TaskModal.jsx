...
export default function TaskModal() {
  const { taskModalOpen, editingTask, closeTaskModal, addTask, updateTask, members, sprints } = useAppStore();

  const [form, setForm] = useState({
    title: "", description: "", priority: "medium", status: "todo",
    type: "task", assigneeId: "", sprintId: "", storyPoints: 3,
    dueDate: "", tags: "",
  });
  ...
  useEffect(() => {
    if (editingTask) {
      ...
      setForm({ title: "", description: "", priority: "medium", status: "todo", type: "task", assigneeId: "", sprintId: "", storyPoints: 3, dueDate: "", tags: "" });
    }
